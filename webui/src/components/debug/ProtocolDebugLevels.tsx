  ...
  return (
    <div className="rounded-lg border border-white/10 bg-gray-950/50 p-4">
      ...
      <div className="relative">
        ...
        {/* Active track */}
        <div
          className={`absolute top-1/2 left-0 h-2 -translate-y-1/2 rounded-full transition-all ${LEVEL_COLORS[config.level]}`}
          style={{ width: `${(levelIndex / (DEBUG_LEVELS.length - 1)) * 100}%` }}
        />
