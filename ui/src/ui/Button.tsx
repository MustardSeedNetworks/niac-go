...
const variantStyles: Record<ButtonVariant, Record<ButtonTone, string>> = {
  ...
  outline: {
    violet:
      'border border-brand-accent/30 text-brand-primary-strong hover:bg-brand-primary/10 hover:border-brand-accent/50 focus:ring-brand-primary',
  ...
  ghost: {
    violet:
      'text-brand-primary-strong hover:bg-brand-primary/10 hover:text-brand-primary-strong focus:ring-brand-primary',
