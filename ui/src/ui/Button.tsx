import { type FC, type ReactNode, type ButtonHTMLAttributes, forwardRef } from 'react';
...
const variantStyles: Record<ButtonVariant, Record<ButtonTone, string>> = {
  solid: {
    violet: 'bg-gradient-to-r from-violet-600 to-violet-500 hover:from-violet-500 hover:to-violet-400 text-white shadow-lg shadow-violet-500/25 focus:ring-violet-500',
    ...
    green: 'bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white shadow-lg shadow-emerald-500/25 focus:ring-emerald-500',
  ...
  outline: {
    violet: 'border border-violet-400/30 text-violet-300 hover:bg-violet-400/10 hover:border-violet-400/50 focus:ring-violet-500',
    red: 'border border-red-400/30 text-red-300 hover:bg-red-400/10 hover:border-red-400/50 focus:ring-red-500',
    green: 'border border-emerald-400/30 text-emerald-300 hover:bg-emerald-400/10 hover:border-emerald-400/50 focus:ring-emerald-500',
...
export const IconButton: FC<IconButtonProps> = ({
  ...
  return (
    <button
      className={`inline-flex items-center justify-center transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-violet-500/50 disabled:opacity-50 disabled:cursor-not-allowed ${sizeStyles[size]} ${variantBase[variant]} ${toneStyles[tone]} ${className}`}
      {...props}
    >
      {icon}
    </button>
