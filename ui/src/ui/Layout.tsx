import { type FC, type ReactNode, createElement, useState, useRef, useEffect } from 'react';
...
export const StatusIndicator: FC<StatusIndicatorProps> = ({
  ...
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      <span className={`relative inline-flex ${sizeClasses[size]} rounded-full ${statusColors[status]}`}>
