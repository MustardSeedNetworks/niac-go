...
export const CardSkeleton: FC<{ className?: string }> = ({
	className = "",
}) => (
...
export const TableRowSkeleton: FC<{ columns?: number; className?: string }> = ({
	...
	<div className={`flex items-center gap-4 p-4 ${className}`}>
		{Array.from({ length: columns }, (_, idx) => `col-${idx}`).map(
			(colKey, i) => (
				<Skeleton
					key={colKey}
					className="flex-1"
...
export const StatCardSkeleton: FC<{ className?: string }> = ({
	className = "",
}) => (
...
export const DeviceCardSkeleton: FC<{ className?: string }> = ({
	className = "",
}) => (
	<div
		className={`p-4 space-y-3 rounded-xl border border-white/5 bg-gray-900/70 ${className}`}
	>
...
export const DeviceTableRowSkeleton: FC<{ className?: string }> = ({
	className = "",
}) => (
	<div
		className={`flex items-center gap-4 px-4 py-3 border-b border-white/5 ${className}`}
	>
		<Skeleton variant="rectangular" width={16} height={16} />
