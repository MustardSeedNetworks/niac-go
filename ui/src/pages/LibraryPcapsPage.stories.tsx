/**
 * Stories for LibraryPcapsPage (/library/pcaps).
 *
...
import { LibraryPcapsPage } from './LibraryFilesPage';

const meta: Meta<typeof LibraryPcapsPage> = {
  ...pageMeta('LibraryPcapsPage', LibraryPcapsPage),
  parameters: { route: '/library/pcaps' },
};

export default meta;
type Story = StoryObj<typeof LibraryPcapsPage>;
...
/** The capture listing returns 500. */
export const Error: Story = { parameters: { api: withFailure('/api/v1/library/pcaps') } };
