/**
 * Stories for TrafficInjectionPage (/traffic).
 *
...
const meta: Meta<typeof TrafficInjectionPage> = {
  ...pageMeta('TrafficInjectionPage', TrafficInjectionPage),
  parameters: { route: '/traffic' },
};

export default meta;
type Story = StoryObj<typeof TrafficInjectionPage>;
...
/** The injectable error types and their targets returns 500. */
export const Error: Story = { parameters: { api: withFailure('/api/v1/errors') }, play: settled() };
