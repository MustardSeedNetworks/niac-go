...
function mapToLogEntry(data: unknown): LogEntry | null {
	...
	return {
		...
		protocol:
			(rawLog.protocol as Protocol) || (rawLog.source as string) || "SYSTEM",
					...
					<div className="flex items-center justify-between">
						...
						<div className="flex items-center gap-3">
							...
							<button
								...
								title={
									connected ? "Connected to log stream" : "Click to reconnect"
								}
							>
								<span
									className={`h-2 w-2 rounded-full ${connectionStatus.indicator}`}
								/>
								<Tag colorScheme={connectionStatus.color}>
