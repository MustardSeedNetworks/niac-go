...
export const DeviceListPage: FC = () => {
	...
	const handleDeviceProtocols = useCallback(
		(device: Device) => getDeviceProtocols(device),
		[],
	);
		...
		<div className="space-y-6">
				...
				<Card className="border-white/5 bg-gray-900/70">
					<CardContent className="py-12 text-center">
						...
						<P className="text-gray-400">
							Add your first device to start configuring your network
							simulation.
						</P>
						<Button
							tone="violet"
			...
			{filteredDevices.length > 0 && viewMode === "table" && (
				<DeviceTableView
					...
					onEdit={(hostname) =>
						navigate(`/device-config/${encodeURIComponent(hostname)}`)
					}
