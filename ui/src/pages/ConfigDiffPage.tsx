...
import {
	MergeControls,
	MergePreviewModal,
} from "../components/config/MergeControls";
					...
					<div className="flex flex-wrap items-center justify-between gap-4">
						<div>
							...
							<P className="text-gray-400 mt-1">
								Compare and merge two YAML configuration files with visual diff
								and merge controls.
							</P>
						</div>
						{hasFiles && (
				...
				<Card className="border-white/5 bg-gray-900/70">
					<CardContent className="py-12 text-center">
						...
						<P className="text-gray-400 max-w-md mx-auto">
							Upload two YAML configuration files above to see a side-by-side
							comparison with color-coded changes and interactive merge
							controls.
						</P>
