...
export const ErrorInjectionPanel: FC = () => {
	...
	const { data: errorInfo, refetch: refetchErrors } = useApiResource(
		fetchErrorTypes,
		[],
		{
			intervalMs: 5000,
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								...
								<SmallText className="text-gray-400 mt-1">
									{
										errorInfo.availableTypes.find(
											(t: ErrorType) => t.type === selectedErrorType,
										)?.description
									}
								</SmallText>
							)}
						...
						<div>
							...
							<input
								...
								value={errorValue}
								onChange={(e) =>
									setErrorValue(Number.parseInt(e.target.value, 10))
								}
												...
												>
													...
													<td className="py-2 px-2">
														<button
															type="button"
															onClick={() =>
																handleClearSpecific(deviceIp, iface)
															}
															disabled={isSubmitting}
