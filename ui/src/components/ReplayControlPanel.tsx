							...
							<div>
								...
								<SmallText className="text-gray-400">
									...
									{replayStatus.loopMs > 0 &&
										` • Looping every ${replayStatus.loopMs}ms`}
									{replayStatus.scale !== 1.0 &&
										` • Scale: ${replayStatus.scale}x`}
								</SmallText>
							</div>
							<Button
								onClick={handleStop}
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						...
						<div>
							...
							<input
								...
								value={loopMs}
								onChange={(e) =>
									setLoopMs(Number.parseInt(e.target.value, 10) || 0)
								}
						...
						<div>
							...
							<input
								...
								value={scale}
								onChange={(e) =>
									setScale(Number.parseFloat(e.target.value) || 1.0)
								}
								disabled={replayStatus?.running}
								className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
							/>
