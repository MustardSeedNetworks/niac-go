...
export const LoadingState: FC<LoadingStateProps> = ({ viewMode }) => {
  if (viewMode === 'table') {
    return (
...
export const ErrorState: FC<ErrorStateProps> = ({ errorMessage, onRetry }) => {
  return (
      ...
      <CardContent className="space-y-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <SmallText className="text-red-300/90">{errorMessage}</SmallText>
...
export const EmptyState: FC<EmptyStateProps> = ({ onAddDevice }) => {
  return (
    <Card className="border-white/5 bg-gray-900/70">
...
export const NoResultsState: FC<NoResultsStateProps> = ({ onClearFilters }) => {
  return (
    <Card className="border-white/5 bg-gray-900/70">
      <CardContent className="py-12 text-center">
