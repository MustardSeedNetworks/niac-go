			...
			{device.netbios?.enabled && (
				<div className="space-y-6">
					<div className="grid gap-4 md:grid-cols-2">
						<FormField
							label="NetBIOS Name"
							helpText="NetBIOS computer name (max 15 chars)"
						>
							<input
								type="text"
						...
						<FormField
							label="TTL (seconds)"
							helpText="Time-to-live for NetBIOS announcements"
						>
							<input
								type="number"
					...
					<div className="space-y-3">
						...
						<div className="flex flex-wrap gap-4">
							{(
								["workstation", "fileserver", "messenger"] as NetBIOSService[]
							).map((service) => (
								<label
									key={service}
