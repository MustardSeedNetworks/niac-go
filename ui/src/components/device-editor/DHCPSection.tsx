					...
					<div className="grid gap-4 md:grid-cols-2">
						<FormField label="Subnet Mask" helpText="DHCP subnet mask">
							<input
								...
								onChange={(e) =>
									updateDhcp({ ...getDhcpConfig(), subnetMask: e.target.value })
								}
						...
						<FormField
							...
							helpText="Router/gateway for clients"
						>
							<input
								type="text"
								value={device.dhcp.router || ""}
								onChange={(e) =>
									updateDhcp({ ...getDhcpConfig(), router: e.target.value })
								}
						...
						<FormField
							label="DNS Server"
							helpText="Domain name server for clients"
						>
							<input
								type="text"
						...
						<FormField label="Domain Name" helpText="Domain suffix for clients">
							<input
								...
								onChange={(e) =>
									updateDhcp({ ...getDhcpConfig(), domainName: e.target.value })
								}
						...
						<FormField label="Pool Start" helpText="Start of DHCP address pool">
							<input
								...
								onChange={(e) =>
									updateDhcp({ ...getDhcpConfig(), poolStart: e.target.value })
								}
						...
						<FormField label="Pool End" helpText="End of DHCP address pool">
							<input
								...
								onChange={(e) =>
									updateDhcp({ ...getDhcpConfig(), poolEnd: e.target.value })
								}
