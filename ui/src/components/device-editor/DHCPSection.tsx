        ...
        <div className="space-y-6">
          <div className="grid gap-4 md:grid-cols-2">
            <FormField label="Subnet Mask" helpText="DHCP subnet mask">
              <input
                ...
                onChange={(e) => updateDhcp({ ...device.dhcp!, subnet_mask: e.target.value })}
            ...
            <FormField label="Default Gateway" helpText="Router/gateway for clients">
              <input
                ...
                onChange={(e) => updateDhcp({ ...device.dhcp!, router: e.target.value })}
            ...
            <FormField label="Domain Name" helpText="Domain suffix for clients">
              <input
                ...
                onChange={(e) => updateDhcp({ ...device.dhcp!, domain_name: e.target.value })}
            ...
            <FormField label="Pool Start" helpText="Start of DHCP address pool">
              <input
                ...
                onChange={(e) => updateDhcp({ ...device.dhcp!, pool_start: e.target.value })}
            ...
            <FormField label="Pool End" helpText="End of DHCP address pool">
              <input
                ...
                onChange={(e) => updateDhcp({ ...device.dhcp!, pool_end: e.target.value })}
          ...
          <div className="space-y-3">
            ...
            <Button
              ...
              onClick={() => {
                const leases = [
                  ...(device.dhcp?.client_leases || []),
                  { mac_address: "", client_ip: "" } as DHCPLease,
                ];
                updateDhcp({ ...device.dhcp!, client_leases: leases });
              }}
            >
