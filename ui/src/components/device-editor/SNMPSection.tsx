			...
			{device.snmpAgent && (
				<div className="grid gap-4 md:grid-cols-2">
					<FormField
						...
						helpText="SNMP v1/v2c community string"
					>
						<input
							type="text"
							value={device.snmpAgent.community || ""}
							onChange={(e) =>
								updateSnmp({ ...getSnmpConfig(), community: e.target.value })
							}
							placeholder="public"
					...
					<FormField label="System Name" helpText="SNMP sysName value">
						<input
							...
							onChange={(e) =>
								updateSnmp({ ...getSnmpConfig(), sysName: e.target.value })
							}
					...
					>
						<select
							...
							onChange={(e) =>
								updateSnmp({ ...getSnmpConfig(), walkFile: e.target.value })
							}
