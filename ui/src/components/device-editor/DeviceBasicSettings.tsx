...
export interface DeviceBasicSettingsProps {
  device: Device;
  isExpanded: boolean;
  onToggle: () => void;
...
/**
 * Basic settings form section for device hostname, MAC, type, and primary IP
 */
export const DeviceBasicSettings: FC<DeviceBasicSettingsProps> = ({
  device,
  isExpanded,
  onToggle,
  onUpdate,
