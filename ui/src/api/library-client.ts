...
/**
 * What a walk says about its own content: captured from a real device and put
 * through the sanitizer, or generated by NIAC from a profile. Absent for
 * pcaps, and for a walk that declares nothing. This is a different question
 * from LibrarySource, which says where the file came from on this machine.
 */
export type WalkProvenance = 'captured' | 'generated';
