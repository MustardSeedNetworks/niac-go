// Package snmp provides varimib (variable MIB) support for time-varying SNMP values.
// This implements compatibility with the Java NIAC varimib format.
package snmp
...
func ParseVariMibValue(value string, asnType gosnmp.Asn1BER, baseValue interface{}) (VariMibHandler, error) {
...
func parseVariMibIntervals(value string, asnType gosnmp.Asn1BER, baseValue interface{}) (VariMibHandler, error) {
	...
	return nil, fmt.Errorf("invalid varimib format: %s", value)
}
...
func NewVariMibFixedHandler(value string, asnType gosnmp.Asn1BER) (*VariMibFixedHandler, error) {
	...
	case gosnmp.Counter64:
		...
		if err != nil {
			return nil, fmt.Errorf("invalid counter64: %s", value)
		}
		parsedValue = v
	...
	case gosnmp.TimeTicks:
		v, err := strconv.ParseUint(value, 10, 32)
		if err != nil {
			return nil, fmt.Errorf("invalid timeticks: %s", value)
		}
		parsedValue = uint32(v)
...
func (h *VariMibFixedHandler) GetValue() interface{} {
	return h.value
}
...
func (h *VariMibIntegralHandler) GetValue() interface{} {
	h.mu.RLock()
	defer h.mu.RUnlock()
...
func (h *VariMibStringHandler) GetValue() interface{} {
	h.mu.RLock()
	defer h.mu.RUnlock()
