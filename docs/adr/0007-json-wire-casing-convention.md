...
NIAC _generates_ SNMP/protocol data on the wire — it does not parse an external
...
may retain snake\_case _internally_ and must map to camelCase before emission.
