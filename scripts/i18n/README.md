...
Every fix had to be applied three times and they drifted anyway — including one
that was fixed in stem and never reached here, leaving the gate able to report
findings and still exit 0 (#1531).
