...
SCAN_ROOT="$fixture" MAX_TS_LINES=5 "$fixture/scripts/check-file-size.sh" >/dev/null

printf '7\n' >> "$fixture/ui/src/legacy.ts"
if SCAN_ROOT="$fixture" MAX_TS_LINES=5 "$fixture/scripts/check-file-size.sh" >/dev/null 2>&1; then
