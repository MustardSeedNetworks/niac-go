...
RUN npm ci
COPY ui/ ./
# Locale JSON sits outside ui/ and is consumed via the @locales Vite/TS
# alias (../internal/i18n/locales). Copy it into the expected sibling path
# so tsc and Vite can resolve the imports during npm run build.
