...
license-check: ## Check license compliance (Go + npm)
	...
	@cd $(UI_DIR) && npx license-checker --production --excludePrivatePackages --onlyAllow "MIT;Apache-2.0;BSD-2-Clause;BSD-3-Clause;ISC;CC0-1.0;0BSD;BlueOak-1.0.0;Unlicense;MPL-2.0" --summary
...
license-report: ## Generate license compliance reports
	...
	@cd $(UI_DIR) && npx license-checker --production --csv > ../build/reports/npm-licenses.csv
