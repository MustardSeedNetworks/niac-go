...
func TestValidateStructure(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err == nil {
				t.Errorf("ValidateStructure() = nil, want %v", tt.wantErr)
				return
			}
			if !errors.Is(err, tt.wantErr) {
				t.Errorf("ValidateStructure() = %v, want error wrapping %v", err, tt.wantErr)
			}
		})
	}
}

func TestValidateGlobalHeaderEndianness(t *testing.T) {
	...
	if err := validateGlobalHeader(beData, true); err != nil {
	...
	if err := validateGlobalHeader(leData, false); err != nil {
